...
Client.prototype.createProject = function(name,customer,cb){
    this.fetch("/api/projects/create",JSON.stringify({customer:customer,name:name}),cb);
}
...
Client.prototype.createCheckout = function(project,opts,cb){
    this.fetch("/api/projects/"+project+"/checkouts/create",JSON.stringify(opts),cb);
}

Client.prototype.getCheckout = function(project,id,cb){
    this.fetchJSON("/api/projects/"+project+"/checkouts/"+id,null,cb);
}
