...
Client.prototype.createRental = function(project,supplier,cb){
    this.fetch("/api/projects/"+project+"/rentals/create",JSON.stringify({supplier:supplier}),cb);
}

Client.prototype.getRental = function(project,id,cb){
    this.fetchJSON("/api/projects/"+project+"/rentals/"+id,null,cb);
}
...
Client.prototype.getCheckout = function(project,id, opts,cb){
    this.fetchJSON("/api/projects/"+project+"/checkouts/"+id+"/"+(opts.reservation||""),null,cb);
}

Client.prototype.updateCheckout = function(project,id,opts,cb){
    this.fetchJSON("/api/projects/"+project+"/checkouts/"+id+"/"+(opts.reservation||""),JSON.stringify(opts.data),cb);
}
