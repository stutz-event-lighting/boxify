...
var Boxify = module.exports = function Boxify(config){
    ...
    //API routes
    this.app.post("/api/sessions/create",bp.json(),require("./routes/sessions/create.js"));
    this.app.get("/api/sessions/:session/delete",require("./routes/sessions/delete.js"));
    ...
    this.app.get("/api/users/:id",ensurePermission("users_read"),require("./routes/users/get.js"));
    this.app.get("/api/users/:id/image",ensurePermission("users_read"),require("./routes/users/image.js"));
    this.app.post("/api/users/:id/save",ensurePermission("users_write"),bp.json(),require("./routes/users/update.js"));
    this.app.post("/api/users/:user/pin",ensurePermission("users_write"),bp.json(),require("./routes/users/setpin.js"));
    this.app.post("/api/users/:user/password",ensurePermission("users_write"),bp.json(),require("./routes/users/setpassword.js"));
    this.app.get("/api/users/:user/delete",ensurePermission("users_write"),require("./routes/users/delete.js"));
