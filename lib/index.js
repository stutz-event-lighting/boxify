...
var Boxify = module.exports = function Boxify(config){
    ...
    this.addRoute("/projects/:project/rentals/:rental",require.resolve("./views/rental.jade"));
    ...
    this.app.post("/api/projects/:project/rentals/create",bp.json(),require("./routes/projects/rentals/create.js"));
    this.app.get("/api/projects/:project/rentals/:rental",require("./routes/projects/rentals/get.js"));
    this.app.post("/api/projects/:project/rentals/:rental",bp.json(),require("./routes/projects/rentals/update.js"));
    this.app.get("/api/projects/:project/rentals/:rental/delete",require("./routes/projects/rentals/delete.js"));
