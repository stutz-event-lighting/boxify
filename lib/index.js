...
var Boxify = module.exports = function Boxify(config){
    ...
    this.app.post("/api/projects/:project/rentals/create",bp.json(),require("./routes/createrental.js"));
    this.app.get("/api/projects/:project/rentals/:rental",require("./routes/getrental.js"));
    this.app.post("/api/projects/:project/rentals/:rental",bp.json(),require("./routes/updaterental.js"));
    this.app.get("/api/projects/:project/rentals/:rental/delete",require("./routes/deleterental.js"));
