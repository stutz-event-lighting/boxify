...
var Barc = require("node-barcode-generator");
...
function App(){
    ...
    this.app.get("/barcode/:code/:name",function(req,res){
        var generator = new Barc();
        var buf = generator.code128(req.params.code,300,100,req.params.name);
