...
var Boxify = module.exports = function Boxify(config){
    ...
    this.app.get("/api/equipment/:type/name",require("./routes/equipment/types/getname.js"));
    this.app.post("/api/equipment/:type/count",bp.json(),require("./routes/equipment/types/updatecount.js"));
    this.app.get("/api/equipment/:type/stock",require("./routes/equipment/types/stock.js"));
    ...
    this.app.get("/api/equipment/:type/:item/container",require("./routes/equipment/items/container.js"));
    ...
    this.app.get("/api/suppliers/:id/image",require("./routes/suppliers/image.js"));
    ...
    this.app.get("/api/projects/:project/checkouts/:checkout",require("./routes/projects/checkouts/get.js"));
    this.app.post("/api/projects/:project/checkouts/:checkout",bp.json(),require("./routes/projects/checkouts/update.js"));
    this.app.get("/api/projects/:project/checkouts/:checkout/delete",require("./routes/projects/checkouts/delete.js"));
    this.app.get("/api/projects/:project/checkins/:checkin",require("./routes/projects/checkins/get.js"));
    this.app.post("/api/projects/:project/checkins/:checkin",bp.json(),require("./routes/projects/checkins/update.js"));
