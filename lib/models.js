...
module.exports = function(db){
    ...
    db.EquipmentItem = db.model("equipment",{
        _id:                ObjectId,
        id:                 Number,
    ...
    db.EquipmentRental = db.model("equipmentrentals",{
        _id:        ObjectId,
        name:       String,
    ...
    db.EquipmentIo = db.model("equipmentio",{
        _id:        ObjectId,
        project:    {type:ObjectId,ref:"projects"},
    ...
    db.EquipmentReservation = db.model("equipmentreservations",{
        _id:        ObjectId,
        project:    {type:ObjectId,ref:"projects"},
        items:Mixed/*{
            TYPE:   Number
