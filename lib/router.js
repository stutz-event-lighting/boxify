...
module.exports = React.createClass({
    getInitialState:function(){
        ...
        visit = function(url,data,cb){
            ((self.refs.component && self.refs.component.verifyLeave)?self.refs.component.verifyLeave:function(cb){cb()})(function(){
                console.log(self.refs.component);
                if(cb){
