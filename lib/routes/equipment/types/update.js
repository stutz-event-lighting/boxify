...
var mongo = require("mongoose/node_modules/mongodb");
...
module.exports = function(req,res){
    ...
    async.parallel([
        ...
        function(cb){
            ...
            var store = new mongo.GridStore(req.app.db.db,parseFloat(req.params.id),parseFloat(req.params.id),"w",{root:"equipmentimages",content_type:mime});
