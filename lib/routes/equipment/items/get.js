...
module.exports = function(req,res){
    ...
    async.parallel([
        function(cb){
            req.app.db.collection("equipment").findOne({type:type,id:id},{id:true,type:true,remark:true,contents:true},cb);
        },
        function(cb){
        ...
        function(cb){
            ...
            req.app.db.collection("equipmentio").find(query,{project:true,time:true,type:true}).sort({time:-1}).limit(1).toArray(function(err,io){
