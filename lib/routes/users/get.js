...
module.exports = function(req,res){
    ...
    async.parallel([
        function(cb){
            req.app.db.collection("users").findOne({_id:id},{firstname:true,lastname:true,email:true,permissions:true,ownedBy:true},cb);
        },
        function(cb){
            req.app.db.collection("users").find({ownedBy:id},{firstname:true,lastname:true}).toArray(cb)
        }
