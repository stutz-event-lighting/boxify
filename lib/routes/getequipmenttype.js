...
module.exports = function(req,res){
    ...
    async.parallel([
        function(cb){
            req.app.db.collection("equipmenttypes").findOne({_id:id},{_id:true,name:true,count:true,weight:true,height:true,width:true,length:true,accessories:true},function(err,item){
