...
function BarcoeScanner() {
    ...
    this.patterns = [[/^EQ\-([0-9]+)$/, function (v) {
        return { kind: "EQ", type: parseFloat(v[0]) };
    }], [/^EQ\-([0-9]+)\:([0-9]+)$/, function (v) {
        return { kind: "EQ", type: parseFloat(v[0]), count: parseFloat(v[1]) };
    }], [/^EQ\-([0-9]+)\-([0-9]+)$/, function (v) {
        return { kind: "EQ", type: parseFloat(v[0]), item: parseFloat(v[1]) };
    }], [/^EQ\-([0-9]+)\-([0-9]+)\:([0-9]+)$/, function (v) {
        return { kind: "EQ", type: parseFloat(v[0]), item: parseFloat(v[1]), count: parseFloat(v[2]) };
    }]];
}
